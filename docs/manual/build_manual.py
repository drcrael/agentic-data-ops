...
def footer(c, doc):
    ...
    if doc.page > 1:
        ...
        c.drawRightString(564, 762, "MVP 0.1.1")
        c.line(48, 39, 564, 39)
        c.setFont("Sans", 7.4)
        ...
        c.drawString(56, 397, "DATA MATURITY AGENT 0.1.1")
        c.setFillColor(colors.white)
        c.setFont("Sans", 10)
...
doc = Manual(
    ...
    subject="Installation and operating manual for Data Maturity Agent 0.1.1",
    invariant=1,
)
